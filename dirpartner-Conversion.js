...
1.2   				20-06-2017			sekar			Added logic to extract 2017 partner information from ITR2,ITR3
---------------------------------------------------------------------------------------------*/
const fs = require('fs'),
...
module.exports = {
    conversionDirPart(filename,orderNo, pullSeqNo,oriRev) {
	...
	var assyear = [];
		...
		var data = fs.readFileSync(FilePaths, 'utf-8'); // reading original file
